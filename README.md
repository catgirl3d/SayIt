...
**Диктування англійською, українською, російською та китайською:** вбудовані промпти очищення доступні англійською та українською. Їхню мову можна окремо вибрати в налаштуваннях AI; під час першого запуску вона відповідає мові інтерфейсу. Мову розпізнавання ASR налаштовуйте окремо та використовуйте модель, яка підтримує мову вашого диктування.
...
- **Інтерфейс українською та англійською** — застосунок автоматично визначає мову системи, яку можна будь-коли змінити в налаштуваннях.
...
<img src="docs/images/readme/home-en.png" width="760" alt="Головний екран SayIt зі статистикою диктування та посиланням на GitHub для зворотного зв'язку">

*Головна — статистика диктування, активна гаряча клавіша та посилання на GitHub для зворотного зв'язку.*
...
Наведені нижче довідкові вимірювання походять з upstream і залежать від обладнання та конфігурації; це не гарантія продуктивності. Qwen3-ASR-1.7B з vLLM на інстансі AWS EC2 `g5.xlarge` (NVIDIA A10G 24 ГБ):
